...
ThemeData get lightTheme => ThemeData(
  ...
  elevatedButtonTheme: ElevatedButtonThemeData(
    style: ButtonStyle(
      ...
      foregroundColor: WidgetStateProperty.all(LightModeColors.lightOnPrimary),
    ),
  ),
  outlinedButtonTheme: OutlinedButtonThemeData(
    style: ButtonStyle(
      ...
      side: WidgetStateProperty.all(
        BorderSide(
          color: LightModeColors.lightOutline.withValues(alpha: 0.6),
          width: 1,
        ),
      ),
      padding: WidgetStateProperty.all(
  ...
  elevatedButtonTheme: ElevatedButtonThemeData(
    style: ButtonStyle(
      ...
      foregroundColor: WidgetStateProperty.all(
        DarkModeColors.darkOnPrimaryContainer,
      ),
    ),
  ),
  outlinedButtonTheme: OutlinedButtonThemeData(
